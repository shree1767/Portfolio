...
const Hero = () => {
  return (
    <div className='hero text-white text-center sm:py-3 pb-10'>
        <h1 className='text-[#5CA4B2] pt-[32vh] md:pl-10 lg:text-[80px] md:text-[65px] text-[45px] font-[700]'>DESIGNER</h1>
